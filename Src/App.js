    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "28px" }}>
          ...
          <button onClick={onClose} style={{ background: "none", border: "none", color: "#888", fontSize: "22px", cursor: "pointer" }}>x</button>
        </div>
              ...
              {(form.footage || []).map((f, i) => (
                <span key={i} style={{ ...tagChip, background: "#1a2a1e", color: "#7fffd4", border: "1px solid #00c89640" }}>
                  ...
                  <button onClick={() => set("footage", form.footage.filter((_, j) => j !== i))}
                    style={{ background: "none", border: "none", color: "#7fffd4", cursor: "pointer", marginLeft: "4px", padding: 0 }}>x</button>
                </span>
              ))}
            </div>
          </Field>
              ...
              {(form.tags || []).map((t, i) => (
                <span key={i} style={{ ...tagChip, background: "#1a1a2e", color: "#a89fff", border: "1px solid #6c63ff40" }}>
                  ...
                  <button onClick={() => set("tags", form.tags.filter((_, j) => j !== i))}
                    style={{ background: "none", border: "none", color: "#a89fff", cursor: "pointer", marginLeft: "4px", padding: 0 }}>x</button>
                </span>
              ))}
            </div>
          </Field>
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "8px" }}>
        ...
        <div style={{ display: "flex", gap: "6px", flexShrink: 0 }}>
          <button onClick={() => onEdit(idea)} style={{ ...iconBtn, color: "#6c63ff" }} title="Edit">edit</button>
          <button onClick={() => onDelete(idea.id)} style={{ ...iconBtn, color: "#ff6b6b" }} title="Delete">del</button>
        </div>
      </div>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
        <span style={{ ...tagChip, background: "#1a1a2e", color: "#c5bfff", border: "1px solid #2a2a3e", fontSize: "11px" }}>{idea.platform}</span>
        <span style={{ ...tagChip, background: "#1a1a2e", color: "#c5bfff", border: "1px solid #2a2a3e", fontSize: "11px" }}>{idea.category}</span>
        ...
        {isOverdue && (
          <span style={{ ...tagChip, background: "#2a1a1e", color: "#ff6b6b", border: "1px solid #ff6b6b40", fontSize: "11px" }}>Overdue</span>
        )}
      </div>
...
export default function ContentIdeaBank() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a12", fontFamily: "sans-serif", color: "#e0e0ff" }}>
      ...
      <div style={{ borderBottom: "1px solid #1a1a2e", padding: "24px 32px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
        <div>
          <h1 style={{ fontSize: "28px", margin: 0, color: "#f0eeff" }}>Content Idea Bank</h1>
        ...
        <button onClick={() => { setEditItem(null); setShowModal(true); }} style={{
          background: "#6c63ff", border: "none", borderRadius: "12px",
              ...
              return (
                <div key={idea.id} style={{ display: "flex", alignItems: "center", gap: "16px", padding: "12px 0", borderBottom: "1px solid #141420" }}>
                  ...
                  <div style={{ display: "flex", gap: "8px", alignItems: "center", flexShrink: 0 }}>
                    ...
                    <button onClick={() => openEdit(idea)} style={{ ...iconBtn, color: "#6c63ff", fontSize: "13px" }}>edit</button>
                  </div>
                </div>
              );
            })}
